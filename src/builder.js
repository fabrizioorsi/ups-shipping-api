    ...
    */
    package: function(package){
        ...
        */
        ...
        if(typeof package.dimensions.width == "undefined") throw new Error("package.weight.length must be defined");
        if(typeof package.dimensions.height == "undefined") throw new Error("package.weight.length must be defined");
